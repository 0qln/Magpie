...
public class CommandParser {
    ...
    //             int wtime = -1, btime = -1, winc = -1, binc = -1, movestogo = -1, depth = 256, mate = -1, movetime = -1;
    //             long nodes = -1;
    ...
    //                     case "perft":
    //                         return Optional.of(b -> new Interface.Custom.PerftCommand(b, iarg + 1 < args.length
    ...
    //             return Optional.of(b -> new GoCommand(b, searchmoves, ponder, wtime, btime, winc, binc, movestogo,
    ...
    public Optional<ICommandBuilder> parse(String input) {
        ...
        while (processedInput.length > 1) {
            ...
            for (var uciCommand : uciCommands) {
                if (uciCommand.protocolName == processedInput[0]) {
